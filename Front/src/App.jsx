          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="p-5 rounded-2xl bg-indigo-950/20 border border-indigo-500/10 text-sm leading-relaxed text-slate-400">
                <p>Được huấn luyện (Train) trên mô hình <span className="text-blue-400 font-semibold">YOLO26</span> mới nhất của Ultralytics. Dataset phân giải 1280x720 được tối ưu cho <span className="text-white font-medium">hệ thống nhận diện rác thải</span> trong không gian công cộng.</p>
              </div>
            </div>
